...
const CHANNEL_CONFIG: Record<string, { icon: string; color: string; gradient: string; name: string }> = {
    slack: {
        icon: "💬",
    ...
    return [
        {
            ...
            channelId: "C123",
            channelName: "#general",
            content: "Hey team! Just wanted to check in on the project status. Are we on track for Friday's deadline?",
        ...
        },
        {
            ...
            channelId: "C123",
            channelName: "#support",
            content: "Customer issue escalated: User unable to access their dashboard after password reset.",
